...
<body>
    ...
    <table width="100%">
        <tr> 
            ...
            <td valign="top" style="font-size: 50px;">ELRICA</td>
            <td align="right">
                <h3>ELRICA PTE. LTD.</h3>
                <pre>
    ...
    <table width="100%">
        <tr>
            <td>
                <b> Invoice No.: {{ $v->invoice_no }} </b><br>
                <b> Invoice Date: </b>  {{ date("l jS \of F Y h:i:s A") }} <br>
                <b> Date: </b> {{ $v->due_date }} <br>
    ...
    <table width="100%">
        ...
        <tfoot>
            <tr>
                ...
                <td style="text-align:center">{{$v->untaxed_amount}}</td>
            </tr>
            <tr>
                <td colspan="4"></td>
                <td style="text-align:center">Gst <span style="font-size:9px;">{{$v->GST}}</span></td>
                <td style="text-align:center">{{($v->GST/$v->untaxed_amount)*100}}%</td>
            </tr>
            <tr>
                <td colspan="4"></td>
