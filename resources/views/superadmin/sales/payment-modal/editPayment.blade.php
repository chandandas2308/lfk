              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="invoiceNo">Invoice Number <span style="color:red; font-size:medium">*</span></label>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="partialamount" class="form-control" id="editpartialamount" placeholder="Partial Amount" readonly />
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
