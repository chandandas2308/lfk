<div class="p-3">
        <div class="page-header flex-wrap">
            ...
            <div class="d-flex">
                <a href="javascript:void(0)" onclick="addSignIn()" class="nav-link bg-addbtn mx-2 rounded">Add</a>
            </div>
        </div>

        <!-- table start -->
        <div class="table-responsive">
        <table class="text-center table table-responsive table-bordered" id="sign_in_main_table">
                <thead>
                    <tr>
