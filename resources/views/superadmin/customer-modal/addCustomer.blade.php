      ...
      <form method="post" id="addCustomerForm">
        <div class="modal-body bg-white px-3">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <!-- <label for="emailId" class="required-field">Email ID</label> -->
              ...
              <div class="form-group">
                ...
                <input type="text" name="phoneNo" id="phoneNo" class="form-control" minlength="7" maxlength="15" placeholder="Home Number" onkeypress="return /[0-9]/i.test(event.key)">
...
<script>
  ...
  $(document).ready(function() {
    jQuery("#addCustomerForm").submit(function(e) {
      e.preventDefault();
      $.ajaxSetup({
        headers: {
    ...
    submitHandler:function(){
      bootbox.confirm("DO YOU WANT TO SAVE?", function(result) {
        if(result){
          jQuery.ajax({
            url: "{{ route('SA-AddCustomer') }}",
            data: jQuery("#addCustomerForm").serialize(),
