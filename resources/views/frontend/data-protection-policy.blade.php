...
@section('title','LFK | Data Protection Policy')
@section('body')

<!--Body Content-->
<div id="page-content" style="margin-bottom: 25px;">
    <!--Page Title-->
    <div class="page section-header text-center mt-5">
        <div class="page-title">
            <div class="wrapper">
                <h1 class="page-width">Data Protection Policy</h1>
            </div>
        </div>
    </div>
    <!--End Page Title-->

    <div class="container data-policy">
        <img src="{{ asset('frontend/images/ykpte-new-logo.png') }}" alt="data-protection-policy-logo">
        <h2 class=""><strong>DATA PROTECTION NOTICE FOR CUSTOMERS</strong></h2>
        <p>
            This Data Protection Notice (“Notice”) sets out the basis which Y K Private Limited (“we”, “us”, or “our”) may collect, use, disclose or otherwise process personal data of our customers in accordance with the Personal Data Protection Act (“PDPA”). This Notice applies to personal data in our possession or under our control, including personal data in the possession of organisations which we have engaged to collect, use, disclose or process personal data for our purposes. 
        </p>
        <h3>
            PERSONAL DATA
        </h3>
        <ul>
            ...
            <li>
                2.	Depending on the nature of your interaction with us, some examples of personal data which we may collect from you include name, residential address, email address, telephone number, nationality and gender.  
            </li>
            <li>
            ...
            <li>
                15.	To safeguard your personal data from unauthorised access, collection, use, disclosure, copying, modification, disposal or similar risks, we have introduced appropriate administrative, physical and technical measures such as minimised collection of personal data, authentication and access controls (such as good password practices, need-to-basis for data disclosure, etc.), and usage of one time password(otp)/2 factor authentication (2fa)/multi-factor authentication (mfa) to secure access.
            </li>
            <li>
            ...
            <li>
                21.	You may contact our Data Protection Officer if you have any enquiries or feedback on our personal data protection policies and procedures, or if you wish to make any request, in the following manner:
                    <br>
                    Name of DPO   : Leon<br>
                    Contact No.   : 88393132<br>
                    Email Address : lfksingapore@gmail.com<br>
            </li>
            <h3>
            ...
            Effective date	: 	14/10/2022<br>
            Last updated	    : 	14/10/2022<br>
        </ul>
