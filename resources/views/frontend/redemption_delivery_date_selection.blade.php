                        ...
                        <div class="">
                            ...
                            <div
                                ...
                                <form class="text-left"
                                    action="{{ route('checkout.redemptionCheckoutSummary', $product_redemption_shops_id) }}"
                                    method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <label for="delivery_date_picker">{{ __('lang.date') }}</label>
                                        @if ($deliver_date != '')
                                            <input type="text" class="form-control" value="{{ $deliver_date }}" disabled
                                        ...
                                        @else
                                            <input type="text" class="form-control" name="delivery_date" required
                                                id="delivery_date_picker" placeholder="{{ __('lang.delivery_date') }}" autocomplete="off">
                                        @endif
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="remark"
                                            @if ($remark != '') value="{{ $remark }}" @endif
                                            id="remark" placeholder="{{ __('lang.remark') }}">
                                    </div>
                                    <button type="submit"
