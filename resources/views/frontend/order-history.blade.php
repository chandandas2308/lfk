...
@section('title', 'LFK | Order History ')
@section('body')
            ...
            <div class="row">
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">{{ GoogleTranslate::trans('Order History', app()->getLocale()) }}</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="" style="margin-bottom: 40px;">
        <div class="title text-center">
            <h2>{{ GoogleTranslate::trans('Order History', app()->getLocale()) }}</h2>
        </div>
        <div class="container">
            ...
            <div class="container">
                ...
                <div class="tab-content">
                    ...
                    <!-- <ul class="nav nav-pills text-center list-inline dashboard-menu text-center">
                        <li class="active"><a data-toggle="pill" href="#pending">Pending Order</a></li>
                        <li><a data-toggle="pill" href="#complete">Complete Order</a></li>
                      </ul> -->
                    <div class="tab-content">
    ...
    <div class="modal fade" id="viewOrderDetails2" tabindex="-1" role="dialog" aria-labelledby="viewOrderDetails2"
        aria-hidden="true">
        <div class="modal-dialog my-auto">
            <div class="modal-content" id="viewOrderDetailsData">
